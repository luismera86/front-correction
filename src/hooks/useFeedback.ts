...
export const useFeedback = () => {
  ...
  const feedbacks = {
    ...
    valueLow: `Tu trabajo a alcanzado el nivel Bajo, esto quiere decir que no cumpliste con la mayoría de los requisitos de la consigna, está desaprobado pero es importante saber que se puede hacer una re entrega del trabajo para levantar la nota, reforzar los conocimientos adquiridos y nunca dejar de practicar, hay que poner un poco más de esfuerzo que se puede llegar muy lejos. Saludos !!!`,
  }
